...
/* package coloracao-gulosos-0.1.0.0 */
#ifndef VERSION_coloracao_gulosos
#define VERSION_coloracao_gulosos "0.1.0.0"
#endif /* VERSION_coloracao_gulosos */
#ifndef MIN_VERSION_coloracao_gulosos
#define MIN_VERSION_coloracao_gulosos(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_coloracao_gulosos */
...
#define CURRENT_COMPONENT_ID "coloracao-gulosos-0.1.0.0-6NBPiiDIbvlIg2SggKVpjU-coloracao-gulosos"
